...
public class stuMenu {
	...
	public static  void showMenu() {
		...
		switch (num) {
		case 1:	new stuMenu().showSysNotice(); break;
		case 2:	new stuMenu().showCNotice(); break;
		case 3:	new stuMenu().showClass(); break;
		case 4:	new stuMenu().showMyPage(); break;
		case 5:	new Login().stu_Login() ; break;
		default:
